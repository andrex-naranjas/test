#Una funcion es un bloque de codigo que solo corre cuando se  le llama. En python no usamos corchetes, usamos intentacion con tabs o espacios
...
total = hacerSuma(2,3)
print(total,"**lo mismo pero mas cool**")
